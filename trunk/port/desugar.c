                      ...
                      if (val != NIL) {
                        ...
                        if (val != NIL) {
                          ...
                          if (val != NIL) {
                            ...
                            if (val != NIL) {
                              decrement_count(val);
                              increment_count(val = global_183);
                              pop_function();
                            } else {
                              push_args();
                              val = NIL;
                                      ...
                                      if (val != NIL) {
                                        ...
                                        if (val != NIL) {
                                          ...
                                          if (val != NIL) {
                                            ...
                                            if (val != NIL) {
                                              decrement_count(val);
                                              increment_count(val = global_191);
                                              pop_function();
                                            } else {
                                              push_args();
                                              val = NIL;
